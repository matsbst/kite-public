...
{#if settings.categoryHeaderPosition === 'bottom'}
  ...
  <button
    class="fixed bottom-8 right-8 w-12 h-12 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-full flex items-center justify-center cursor-pointer transition-all duration-300 z-50 shadow-lg hover:shadow-xl hover:-translate-y-0.5 active:translate-y-0 max-md:bottom-20 max-md:right-6 max-md:w-11 max-md:h-11"
...
{:else}
  ...
  <button
    class="fixed bottom-8 right-8 w-12 h-12 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-full flex items-center justify-center cursor-pointer transition-all duration-300 z-50 shadow-lg hover:shadow-xl hover:-translate-y-0.5 active:translate-y-0 max-md:bottom-6 max-md:right-6 max-md:w-11 max-md:h-11"
    class:opacity-0={!visible}
    class:invisible={!visible}
    class:opacity-100={visible}
    class:visible={visible}
